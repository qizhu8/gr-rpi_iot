...
namespace gr {
  namespace rpi_iot {
     ...
     */
    BER_bbf_impl::~BER_bbf_impl()
    {
    }

    void
    BER_bbf_impl::forecast (int noutput_items, gr_vector_int &ninput_items_required)
    {
    ...
    int
    BER_bbf_impl::general_work (int noutput_items,
